  ...
  return (
    <BloodyPureContainer>
      ...
      <div className="what-we-do sec-color">
        ...
        <div className="text">
          <h1>India</h1>
          India is home to approximately 120 million adolescent girls— roughly
          10% of the Indian population. A girl menstruates on an average of five
          days a month, 12 months a year, and this cycle carries on until she
          reaches menopause between the ages of 30–40. Periods are normal and
          healthy, yet many girls across both rural and urban India struggle to
          manage this monthly occurrence. Menstrual taboos are still widespread
          and commonplace in our society. Most women, even those working in
          corporations, are hesitant to apply for leave due to menstrual cramps
          or other menstrual symptoms, instead labeling it as merely a
          stomachache. This is a clear sign of the systemic imprinting that
          occurs in our society that leads to the perception that menstruation
          is a problem or a disease. At #BloodyPure, we strive to undo this
          imprinting, for both men and women.
        </div>
      </div>
      <div className="what-we-do ">
        <div className="text">
